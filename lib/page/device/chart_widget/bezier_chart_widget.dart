  ...
  void paint(Canvas canvas, Size size) {
    ...
    void _drawBezierLinePath(BezierLine line) {
      ...
      for (int i = 0; i < xAxisDataPoints.length; i++) {
        ...
        String bottomText = _getFooterText(xAxisDataPoints[i]);

        if (bottomText.length == 4) {
          bottomText=bottomText.substring(0, 1)+"\n"+bottomText.substring(3);
        } else {
          bottomText=bottomText.substring(0, 2)+"\n"+bottomText.substring(4);
        }
        //draw footer
      ...
      if (config.showDataPoints) {
        ...
        if (!kIsWeb) {
          canvas.drawPoints(
              ...
              paintControlPoints
                ..style = PaintingStyle.stroke
                ..strokeWidth = line.linePointWidth
        ...
        if (animation.isCompleted) {
          ...
          textPainter.paint(
            ...
            Offset(
              ...
              //標籤高度  原本 center.dy - offsetInfo - infoHeight / 2.5
              center.dy - offsetInfo - infoHeight / 2.5+5,
            ),
          );
